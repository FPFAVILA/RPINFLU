          ...
          {needsKYCVerification && (
            <div className="bg-yellow-50 border-2 border-yellow-300 rounded-xl p-4 mb-4">
              ...
              <p className="text-yellow-700 text-sm mb-3 leading-relaxed">
                A verificação KYC confirma o titular da conta e libera funções financeiras como saque e depósito. É uma medida de segurança obrigatória para liberar saques.
              </p>
